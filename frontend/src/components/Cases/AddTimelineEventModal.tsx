...
import { addTimelineEvent } from '@/lib/api/cases';
...
export default function AddTimelineEventModal({ isOpen, onClose, onSuccess, caseId }: AddTimelineEventModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addTimelineEvent(caseId, submitData);
